...
class AuthController extends Controller
{
    ...
    public function register(Request $request)
    {
        ...
        return redirect('/'); // Перенаправление на страницу после успешной регистрации и входа
    }
    ...
    public function login(Request $request)
    {
        ...
        if (Auth::attempt($credentials)) {
            // Если пользователь успешно аутентифицирован, выполните действия, которые должны произойти после успешного входа.
            return redirect()->intended('/'); // Здесь вы можете изменить путь перенаправления после успешного входа.
        } else {
            // Если аутентификация не удалась, верните пользователя на страницу логина с ошибкой.
